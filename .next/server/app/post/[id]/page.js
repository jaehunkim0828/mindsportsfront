...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4803)), "/Users/kimjaehun/Documents/rest/bock/front/app/post/[id]/page.jsx"],
    ...
    manifest: undefined
        ...
        {
          'layout': [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7228)), "/Users/kimjaehun/Documents/rest/bock/front/app/layout.js"],
          metadata: {
    icon: [(async (props) => (await Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 4756))).default(props))],
    apple: [],
    openGraph: [],
    ...
    const pages = ["/Users/kimjaehun/Documents/rest/bock/front/app/post/[id]/page.jsx"];
    ...
    const originalPathname = "/post/[id]/page"
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 6814))
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ TodayPage)
/* harmony export */ });
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6786);
/* harmony import */ var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(248);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(8038);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var _page_module_scss__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(6251);
...
function TodayPage({ params: { id  }  }) {
    ...
    const [commend, setCommend] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)({
        up: 0,
        down: 0
    });
    const [view, setView] = (0,react__WEBPACK_IMPORTED_MODULE_1__.useState)(0);
    ...
    const handleReaction = async (id, recommend, deprecated, type)=>{
        ...
        await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].put */ .Z.put(`${"http:/localhost:5000"}/post/id?id=${id}`, {
            recommend,
            deprecated
        });
        if (type === "up") {
    ...
    const submitCommnet = async ()=>{
        ...
        const result = await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].post */ .Z.post(`${"http:/localhost:5000"}/comment`, {
            id,
            nick: form.nick,
    ...
    (0,react__WEBPACK_IMPORTED_MODULE_1__.useEffect)(()=>{
        (async ()=>{
            const result = await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].get */ .Z.get(`${"http:/localhost:5000"}/post/id?id=${id}`).then((raw)=>raw.data);
            setPost(result.data);
            setCommend({
                up: result.data.recommend,
                down: result.data.deprecated
            });
            const result2 = await axios__WEBPACK_IMPORTED_MODULE_3__/* ["default"].get */ .Z.get(`${"http:/localhost:5000"}/comment/postId?id=${id}`).then((raw)=>raw.data);
    ...
    return /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
        className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().postContainer),
        children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().postWrapper),
            children: [
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().title),
                    children: [
                        post.img && /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                            src: `${"http:/localhost:5000"}/${post.img}.png`,
                            alt: "smile"
                        }),
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().info),
                            children: post.title
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().sub),
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().first),
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            children: post.nick
                                        }),
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            children: dayjs__WEBPACK_IMPORTED_MODULE_2___default()(post.createdAt).format("MM.DD.YYYY")
                                        })
                                    ]
                                }),
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().last),
                                    children: [
                                        "조회: ",
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().body),
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().content),
                            children: post.content?.split("\n").map((line, i)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("span", {
                                    children: [
                                        line,
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().reaction),
                            children: [
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    onClick: ()=>handleReaction(post.id, post.recommend + 1, post.deprecated, "up"),
                                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().row),
                                    children: [
                                        "추천",
                                        commend.up,
                                ...
                                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    onClick: ()=>handleReaction(post.id, post.recommend, post.deprecated + 1, "down"),
                                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().row),
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                                            src: "/noRecommend.png",
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().commentList),
                    children: [
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().count),
                            children: [
                                "댓글 (",
                                comment.length,
                                ")"
                        ...
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().comments),
                            children: comment.map((ele, i)=>/*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().comment),
                                    children: [
                                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().who),
                                            children: /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().first),
                                                children: [
                                                    /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("img", {
                                                    ...
                                                    /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                                                        className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().created),
                                                        children: [
                                                            " ",
                                                            dayjs__WEBPACK_IMPORTED_MODULE_2___default()(ele.createdAt).format("MM.DD.YYYY HH:mm")
                                                        ]
                                                    })
                                                ]
                                            })
                ...
                /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                    className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().send),
                    children: [
                        /*#__PURE__*/ react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().intro),
                            children: "댓글 쓰기"
                        }),
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().name),
                            children: [
                                "닉네임:",
                                " ",
                        ...
                        /*#__PURE__*/ (0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsxs)("div", {
                            className: (_page_module_scss__WEBPACK_IMPORTED_MODULE_4___default().form),
                            children: [
...
// Exports
module.exports = {
	"postContainer": "page_postContainer__Oszic",
	"postWrapper": "page_postWrapper__nw6ZJ",
	"title": "page_title__GbZGc",
	"info": "page_info___1HrO",
	"sub": "page_sub__OzN1Q",
	"first": "page_first__ev1jW",
	"last": "page_last___3W9h",
	"body": "page_body__TRm1_",
	"content": "page_content__pggKx",
	"reaction": "page_reaction__mmD8A",
	"row": "page_row__EY_Fh",
	"commentList": "page_commentList__BkbOS",
	"count": "page_count__cIUEJ",
	"comments": "page_comments__UK7Bf",
	"comment": "page_comment__MWoqz",
	"who": "page_who__GEoap",
	"created": "page_created__QKjPo",
	"icon": "page_icon__XS8yl",
	"send": "page_send__HfzjW",
	"intro": "page_intro__vB4NU",
	"name": "page_name__Z9jwp",
	"form": "page_form__Hk_wL"
};
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`/Users/kimjaehun/Documents/rest/bock/front/app/post/[id]/page.jsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [405,282,248,598,460], () => (__webpack_exec__(2373)));
